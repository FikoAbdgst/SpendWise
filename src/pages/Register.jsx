        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded ${
                fieldErrors.email ? "border-red-500" : darkMode ? "border-gray-600" : "border-gray-300"
              } ${
                darkMode
                  ? "bg-gray-700 text-white placeholder-gray-400"
                  : "bg-white text-gray-900 placeholder-gray-500"
          ...
          <button
            type="submit"
            className="w-full bg-green-500 cursor-pointer text-white py-2 px-4 rounded hover:bg-green-600 transition duration-200"
            disabled={loading}
          >
