        ...
        <div className="flex justify-between items-center mb-2 md:mb-3 sticky top-0 z-20">
          ...
          <div className="relative">
            <button
              ...
              className={`flex items-center gap-1 cursor-pointer text-xs md:text-sm font-medium ${
                darkMode
                ...
                <div className="flex justify-between items-center">
                  ...
                  >
                    ...
                    <span className="xs:hidden">
                      {item.type === "income" ? "+" : "-"}Rp
                      {Math.abs(Math.round(item.amount)).toLocaleString("id-ID").substring(0, 5)}...
                    </span>
                    {item.type === "income" ? (
