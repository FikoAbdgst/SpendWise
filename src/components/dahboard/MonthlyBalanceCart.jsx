...
const MonthlyBalanceChart = ({ darkMode }) => {
  ...
  useEffect(() => {
    if (timeFrame === "weekly" || timeFrame === "daily") {
      ...
      if (
        ...
        (!selectedWeek || !weeksInMonth.some((w) => w.weekNumber === selectedWeek))
      ) {
  ...
  const shouldShowTimeFilter =
    timeFrame === "yearly" || timeFrame === "monthly" || (timeFrame === "weekly" && showFilterModal);

  return (
    <div
      className={`w-full p-4 rounded-lg ${darkMode ? "bg-gray-800 text-white" : "bg-white"} shadow-md`}
    >
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-2">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full md:w-auto">
          ...
          <div className="relative">
            <select
              className={`w-full sm:w-auto px-3 py-2 rounded-md text-sm font-medium focus:outline-none ${
                darkMode
          ...
          {shouldShowTimeFilter && (
            <button
              ...
              className={`w-full sm:w-auto px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                darkMode
      ...
      <div className="mt-4 text-sm text-center">
        <p className="text-xs sm:text-sm">
          {timeFrame === "yearly"
            ...
            : timeFrame === "weekly"
            ? `Data Harian Minggu ${selectedWeek} Bulan ${getMonthName(
                selectedMonth
              )}, ${selectedYear}`
      ...
      {showFilterModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center p-4">
          <div
            className={`w-full max-w-md p-4 sm:p-6 rounded-lg shadow-lg ${
