...
const Sidebar = ({ setIsLoggedIn, darkMode }) => {
    ...
    return (
        <div className={`${darkMode ? 'bg-gray-800 text-gray-300' : 'bg-white text-gray-500'} w-full h-full flex flex-col border-r ${darkMode ? 'border-gray-700' : 'border-gray-200'} transition-colors duration-200`}>
            {/* Logo */}
            <div className="px-4 md:px-6 py-4 md:py-6">
                <div className="flex justify-start items-center space-x-2">
                    <h2 className={`text-lg md:text-xl font-bold ${darkMode ? 'text-white' : 'text-black'}`}>Spend Wise</h2>
                </div>
            </div>
            ...
            <div className="py-6 md:py-10 pr-4 md:pr-14 mt-auto">
                <button
                    ...
                    className={`flex items-center px-4 py-2 md:py-3 w-full ${darkMode ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-500 hover:bg-gray-100'} rounded-r-xl transition-colors duration-200`}
                >
