    ...
    >
      <div className="px-4 md:px-6 py-4 md:py-6">
        <div className="flex justify-start items-center space-x-2">
          ...
          <h className="text-xl md:text-2xl font-bold  text-white">Spendtvise</h>
        </div>
      </div>
      ...
      <div className="py-6 md:py-10 pr-4 md:pr-14 mt-auto">
        <button
          ...
          className={`flex items-center cursor-pointer px-4 py-3 w-full 
            ${darkMode ? "text-gray-400 hover:bg-red-800" : "text-red-500 hover:bg-red-200"} 
            font-semibold rounded-r-lg transition-all duration-200`}
        >
