...
const FormInputExpense = ({ showForm, darkMode, editMode, resetForm, handleSubmit, setShowIconSelector, showIconSelector, selectedIcon, handleIconSelect, handleInputChange, formData, handleDateChange, loading }) => {
    return (
        <>
            {showForm && (
